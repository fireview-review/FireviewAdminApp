                    ...
                    <div className="row ">
                        <div className="col-md-12 ">
                            ...
                            <div className="tf-heading wow fadeInUp">
                                ...
                                <p className="sub-heading">At Galenai, we revolutionize learning by integrating practical, immediate, and interactive educational experiences. Our AI-driven platform tailors real-world skills directly to your personal and professional goals, making learning not just effective but truly engaging. We're dedicated to making continuous education accessible and enjoyable, enabling you to apply new knowledge instantly in everyday scenarios.</p>
                            </div>
